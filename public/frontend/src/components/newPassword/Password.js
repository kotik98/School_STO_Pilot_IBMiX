        ...
        this.props.form.validateFields(async (err, values) => {
            if (!err) {
                ...
                if (result.response === 'success') {
                    ...
                    openNotification('topRight', 'warning', 'Warning', 'Неправильно указан email, пожалуйста попробуйте еще раз!')
            ...
            <div className="registerForm">
                ...
                <Card style={{ borderRadius: '20px', marginTop: '11%', marginBottom: '11%' }}>
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <h3 style={{ color: '#4a76a8' }}>Для получения пароля введите email, указанный при регистрации.<br />
