        ...
        this.props.form.validateFields(async (err, values) => {
            if (!err) {
                ...
                if (result.response === 'ok') {
                    ...
                    message.success(`Успешно! Новый пароль установлен, используйте его для входа в наш сервис!`, 5);

                    this.setState({
                        isRedirect: true
                    })
                } else {
                    openNotification('topRight', 'warning', 'Warning', 'Проверьте правильность ввода паролей!')
    ...
    render() {
        ...
        return (
            <div className="registerForm">
                ...
                <Card style={{ borderRadius: '20px', marginTop: '11%', marginBottom: '11%' }}>
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        <Form.Item hasFeedback>
                            ...
                            })(<Input.Password placeholder="Придумайте новый пароль профиля" />)}
                        </Form.Item>
