      ...
      if (!err) {
        ...
        if (result.response === 'success') {
          if (crewRole === 'пилот') {
            ...
            message.success(`Новый командир эскадрильи успешно зарегистрирован`,
                5);
            this.props.cookies.set('Role', crewRole);
            this.props.cookies.set('station', 'station');
          }
        ...
        openNotification('topRight', 'warning', 'Warning',
            'Выберите поле "Пилот" или поле "Командир эскадрильи", а также проверьте правильность заполнения других полей');
      }
    });
  };
            ...
            <Form onSubmit={this.handleSubmit}>
                  ...
                  rules: [
                    ...
                    },
                    {
                      validator: this.validateToNextPassword,
                                   ...
                                   placeholder="Придумайте пароль профиля"/>)}
              </Form.Item>
              ...
              < Form.Item>
                <Button style={{
                  ...
                  width: '100%',
                  align: 'center',
                }} htmlType="submit" loading={this.state.iconLoading}
                        icon='solution'>
                  Зарегитрировать
                </Button>
              </Form.Item>
            </Form>
            <div align={'center'}><br/><Link
                to={'/login'}>Войти</Link><br/><Link to={'/our_company'}>О
              нас</Link></div>
          </Card>
        </div>
